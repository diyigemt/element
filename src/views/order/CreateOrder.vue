        ...
        <el-form label-position="left"
          ...
          <el-table stripe empty-text="空" :data="orderForm.goods" show-summary :summary-method="getSummaries">
            ...
            <el-table-column label="编码">
              <template slot-scope="scope">
                <el-input v-model.number="orderForm.goods[scope.$index].code"></el-input>
<!--                <span>{{goodsList[orderForm.goods[scope.$index].id - 1].code}}</span>-->
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.orderForm.goods = [{id: 1, code: 13177421234, key: Date.now(), count: 1}]
    },
    removeGood(item) {
